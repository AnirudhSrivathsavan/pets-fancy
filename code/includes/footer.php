  ...
  <div class="copyright">
      <div class="inside-container">
          <div class="row">
              ...
              <div class="col-md-3 order-2 order-md-12"></div>
              <div class="col-md-3 social order-2 order-md-12">
                  <a href="#" class="fa"><i class="fa-brands fa-square-facebook"></i></a>
                  ...
                  <a href="#" class="fa"><i class="map fa-solid fa-map-location-dot"></i></a>
              </div>                
              </div>
          </div>
      </div>
